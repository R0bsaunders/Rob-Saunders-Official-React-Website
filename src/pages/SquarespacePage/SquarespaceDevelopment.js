      ...
      <main>
          <Helmet>
              ...
              <meta name="description"
                    content="I'm a Squarespace web designer building professional and modern websites from £600! Get in touch now!"/>
          ...
          <section id='notice' className='text-center mt-5 px-5'>
              <div>
                  <h2 className='mb-3'>New Squarespace project start date
                      - {moment(priorDate).format("dddd, MMMM Do YYYY")}</h2>

                  <p>Due to it being surprisingly busy at the moment, with several new website builds on the go, I am
                      able to schedule in new Squarespace website builds 3 weeks from the deposit payment. For example,
                      if deposit is paid today then I would be able to schedule starting your project on the above
                      date.</p>
                  <p>On a positive note, that gives you a bit more time to put pen to paper and write up your website
                      content - oh how we love writing content haha!
                      <br/>
                      Thanks, Rob
                  </p>
              </div>
          ...
          <section>
              <div className="page-break-background rockBackground">
                  ...
                  <div id="content-box-4" className="page-break">
                      ...
                      <p>If you're looking for a Squarespace website designer or developer to build you a simple website
                          that looks modern, performs well and most importantly, your customers love, then get in touch
                          with me now. I'm based in Chard, Somerset, and would love to come and see you, or have a video
                          chat! I won't confuse you with technical words or try to sell you something you don't
                          need.</p>
