  ...
  return (
    <>
        ...
        <div className="contactWrapper">
            ...
            <span id="contactEmailReveal" className="revealEmailSpan"><button data-id="contactEmailReveal" className="btn btn-primary btn-lg navCTA" onClick={printEmail}>Reveal Email</button></span><br />
            ...
            <div id ="formWrapper" >
                ...
                <hr />
                    ...
                    <p>Please note that by submitting this form you agree to be contacted by phone / email and agree that your data will be managed according to the <Link to='/privacy-policy/#' target="_blank" className="linkOnPurple">Privacy Policy</Link></p>

                    <div>
                        <button id="submitButton" type="submit" className="onPurpleButton">Submit</button>
                    </div>
